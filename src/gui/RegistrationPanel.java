...
public class RegistrationPanel extends JPanel {
	...
	public RegistrationPanel(MainWindow mainWindow) {
		...
		registrationButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(loginCorrect(loginTextField.getText()) && passwordsCorrect(String.valueOf(firstPasswordField.getPassword()), 
						String.valueOf(repeatPasswordField.getPassword())) && peselCorrect(peselTextField.getText()))
				{
	...
	private boolean peselCorrect(String pesel)
	{
		for(int i=0; i<10; i++)
		{
			if(pesel.contains(String.valueOf(i)))
			{
				return false;
			}
		}
