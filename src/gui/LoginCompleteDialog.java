...
public class LoginCompleteDialog extends JDialog {
	...
	private static final long serialVersionUID = 3921209975231238068L;
	...
	public LoginCompleteDialog(MainWindow mainWindow, String whichGui) {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(succesLogged).addGap(35))
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(
				GroupLayout.Alignment.LEADING, groupLayout.createSequentialGroup().addGap(30).addComponent(succesLogged)
