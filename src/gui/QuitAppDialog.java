...
public class QuitAppDialog extends JDialog {
	...
	private static final long serialVersionUID = -3720326891189687501L;
	...
	public QuitAppDialog() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(20)
						...
						.addComponent(cancelButton, GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE).addGap(18))
				.addGroup(groupLayout.createSequentialGroup().addGap(55).addComponent(messageLabel).addContainerGap(56,
						Short.MAX_VALUE)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addGap(33).addComponent(messageLabel).addGap(18).addGroup(groupLayout
